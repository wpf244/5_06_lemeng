...
class Assess extends BaseAdmin
{
    ...
    {
        $list=\db("assess")->alias('a')->field("a.id,a.content,name,addtime")->where("a.status=0")->order("a.id desc")->join("riders b","a.rid=b.id")->paginate(10);
    ...
    public function index()
    {
        ...
        $list=\db("assess")->alias('a')->field("a.id,a.content,name,addtime")->where($map)->where("a.status=1")->order("a.id desc")->join("riders b","a.rid=b.id")->paginate(10);
        $this->assign("list",$list);
